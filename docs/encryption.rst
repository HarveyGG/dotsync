...
dotsync allows you to encrypt files that you don't want to be stored in
...
* Encrypted files are not directly linked to your dotfiles repository. This
  means you need to run ``dotsync update`` whenever you want to save changes you
...
When you add an encrypted dotfile to your repo for the first time dotsync will
